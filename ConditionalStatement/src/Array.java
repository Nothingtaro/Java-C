...
public class Array {
    ...
    public static void demo4() {
        ...
        String[][] provinces2 = new String[4][2]; // 4 rows 2 columns
        ...
        for (int i = 0; i < provinces3.length; i++) { // 4 rows
            for (int j = 0; j < provinces3[i].length; j++) { // 2 columns
                System.out.printf("province3[%d][%d] = %s\n",i, j, provinces3[i][j]);
            }
        }
    }
...
//        Arrays.sort(coffees);
    ...
    /**array -> pass my referencing -> ผ่าน address ของหน่วยความจำ
     *       -> ตัวแปร n ใน t1() และ ตัวแปร x ใน demoT1 ชี้ไปที่หน่วยความจำเดียวกันที่เก็บค่า array ของ int
    **/
    public static void demoT2(int x) {
        x = x * 10;
        System.out.println("--in demoT2--");
